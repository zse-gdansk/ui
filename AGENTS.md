...
5. **Po polsku.** Teksty interfejsu (etykiety, komunikaty, `aria-label`) po polsku, z polską odmianą liczebników (`Intl.PluralRules("pl-PL")`). Komentarze w kodzie po polsku i oszczędnie: tylko to, czego nie widać z kodu.
